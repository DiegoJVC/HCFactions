...
import com.cobelpvp.hcfactions.deathmessage.objects.MobDamage;
...
public class ArrowTracker implements Listener {
    ...
    public void onEntityShootBow(EntityShootBowEvent event) {
        if (event.getEntity() instanceof Player) {
            event.getProjectile().setMetadata("ShotFromDistance", new FixedMetadataValue(HCFactions.getInstance(), event.getProjectile().getLocation()));
        }
    }
